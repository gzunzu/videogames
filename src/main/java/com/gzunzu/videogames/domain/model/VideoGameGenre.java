...
public class VideoGameGenre implements Serializable {
    private static final long serialVersionUID = -3269595842608257225L;

    @Id
    @SequenceGenerator(name = "videogame_genre_id_sequence",
            sequenceName = "videogame_genre_id_sequence")
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
            generator = "videogame_genre_id_sequence")
    @JsonIgnore
    private long id;
